package cn.edu.gdmec.a07150847.mymap;
...
public class MainActivity extends AppCompatActivity {
        ...
        OnGetPoiSearchResultListener getPoiSearchResultListener = new OnGetPoiSearchResultListener() {
                ...
                if (poiResult.error == SearchResult.ERRORNO.NO_ERROR) {
                    ...
                    Toast.makeText(MainActivity.this,
                            "总共查到:" + poiResult.getTotalPoiNum() + "个兴趣点，分为:"
                                    + poiResult.getTotalPageNum() + "页", Toast.LENGTH_LONG).show();
                    return;
                }
            }
            ...
            public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
                if (poiDetailResult.error != SearchResult.ERRORNO.NO_ERROR) {
                    Toast.makeText(MainActivity.this,
                            "没有结果", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MainActivity.this,
                            "\n你是吃货", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private void setOverlay() {
        ...
        OverlayOptions overlayOptions = new MarkerOptions().position(jidian).icon(bitmapDescriptor);
    ...
    private void setMapText() {
        OverlayOptions overlayOptions = new TextOptions().text("机电")
                .fontColor(0xFFFF00FF).fontSize(20).bgColor(0xAAFFFF00).position(jidian).rotate(45);
        baiduMap.addOverlay(overlayOptions);

    }

    private void POISearch() {
        poiSearch.searchNearby(new PoiNearbySearchOption().location(jidian).keyword("餐厅")
                .radius(1000).pageNum(1));
    }
    ...
    private void GPSLocation() {
        ...
        String procider = LocationManager.GPS_PROVIDER;
        ...
        locationManager.requestLocationUpdates(procider, 2000, 10, locationListenner);
    }

    private final LocationListener locationListenner = new LocationListener() {
        @Override
